...
namespace VulkanSimplified
{
	...
	public:
		...
		ListObjectID<VkVertexInputBindingDescription> AddVertexInputBindingDescription(uint32_t binding, const std::vector<VertexAttributeFormats>& attributes, bool useInstanceIndex);
