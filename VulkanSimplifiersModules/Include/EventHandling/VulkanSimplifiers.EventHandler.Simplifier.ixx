export module VulkanSimplifiers.EventHandler.Simplifier;
...
{
public:
	EventHandlerSimplifier(EventHandlerInternal& ref);
	~EventHandlerSimplifier();

	EventHandlerSimplifier& operator=(const EventHandlerSimplifier&) noexcept = delete;
...
private:
	EventHandlerInternal& _internal;
};